...
const AcademicUnpaidAndPaidDataTable = ({
  url,
  columns,
  loadingFun,
  exportBaseUrl,
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <h6 className="card-title mb-0 fw-semibold text-dark">
               Select These Filter to Get Student Fee Report
              </h6>
        ...
        <div className="card-body px-4 pb-4 pt-3">
          <div className="row g-3 g-lg-4 align-items-end">
            ...
            <div className="col-md-6 col-lg-3 d-flex align-items-end">
              ...
              >
                <Icon icon="solar:search-bold" className="fs-5" />
                Search
              </button>
            </div>
          </div>
...
export default AcademicUnpaidAndPaidDataTable;