...
const AcademicOnlineFeeReportDataTable = ({
  url,
  columns,
  loadingFun,
  syncUrl = `${baseURL}/api/fees/sync-transactions`,
  exportBaseUrl,
}) => {
  ...
  /** Sync (independent of DataTable filters) */
  ...
  console.log('all classes are:',classes);
  ...
  return (
    <div className="fee-report-scope d-flex flex-column gap-4 pb-2">
      <section
        ...
        aria-label="Transaction sync"
      >
        <div className="card-header border-0 bg-primary bg-opacity-10 py-3 px-4">
          <div className="d-flex align-items-center gap-3">
            <span className="fee-report-icon-wrap bg-primary text-white shadow-sm">
              <Icon icon="solar:refresh-circle-bold-duotone" className="fs-4" />
            </span>
            <div>
              ...
              <p className="small text-muted mb-0 mt-1">
                Pull or refresh transactions for the selected date range
              </p>
            </div>
          </div>
        </div>
        <div className="card-body px-4 pb-4 pt-3">
          <div className="row g-3 g-lg-4 align-items-end">
            ...
            <div className="col-md-4 col-lg-auto d-flex align-items-end">
              <button
                type="button"
              ...
              >
                {syncLoading ? (
                  ...
                  <>
                    <Icon icon="solar:cloud-download-bold" className="fs-5" />
                    Sync
                  </>
                )}
              </button>
...
export default AcademicOnlineFeeReportDataTable;