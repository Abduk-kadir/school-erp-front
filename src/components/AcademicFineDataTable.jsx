...
/** Server-side / export param: lowercase 3-letter month (jan, feb, mar, …). */
...
const AcademicFineDataTable = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res1 = await axios.get(`${baseURL}/api/classes`);
...
export default AcademicFineDataTable;