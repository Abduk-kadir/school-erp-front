...
const CanteenOfflinePaymentReportPage = () => {
  return (
    <div>
      <AcadmicOfflineFeeReportDataTable url={`${baseURL}/api/canteen-fees/allfee-collection`} columns={feeReportColumns} />
    </div>
  );
};

export default CanteenOfflinePaymentReportPage;
