...
const CanteenAllFeeTransactionPage = () => {
  return (
    <div>
      <AcademicAllTransactionReportDataTable url={`${baseURL}/api/canteen-fees/allfee-collection`} columns={feeReportColumns} />
    </div>
  );
};

export default CanteenAllFeeTransactionPage;
