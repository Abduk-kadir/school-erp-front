...
const TitlePage = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            await axios.post(`${baseURL}/api/titles`, data);
            setSuccessMsg('Title add successfully');
    ...
    const handleDelete = async (id, table) => {
        ...
        try {
            console.log(id)
            let { data } = await axios.delete(`${baseURL}/api/titles/${id}`)
            alert('title is  deleted successfully')
    ...
    return (
        ...
        <div class="table-action-group">
          <button type="button" class="table-action-btn table-action-edit" data-id="${row.id}" title="Edit Title">Edit</button>
          <button type="button" class="table-action-btn table-action-delete" data-id="${row.id}" title="Delete Title">Delete</button>
        </div>
      `;
                        },
                    },
