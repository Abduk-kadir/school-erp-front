...
import AcademicOnlineFeeReportDataTable from "../../../components/AcademicOnineFeeReportDataTable";
...
const AdmissionOnlineFeeReportPage = () => {
  return (
    <div>
      <AcademicOnlineFeeReportDataTable url={`${baseURL}/api/admission-fees/allfee-collection`} columns={feeReportColumns} />
    </div>
  );
};

export default AdmissionOnlineFeeReportPage;
