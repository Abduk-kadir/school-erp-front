...
const AdmissionOfflinePaymentReportPage = () => {
  return (
    <div>
      <AcadmicOfflineFeeReportDataTable url={`${baseURL}/api/admission-fees/allfee-collection`} columns={feeReportColumns} />
    </div>
  );
};

export default AdmissionOfflinePaymentReportPage;
